...
// TIM17	CONT SYS 10US				16
// TIM23	E							32
// TIM24	E							32

NVIC_SetPriority(SysTick_IRQn, 14);			// SYS TICK
//NVIC_SetPriority(DMA1_Stream1_IRQn, 0);		// ADC DMA
//NVIC_SetPriority(TIM17_IRQn, 1);			// TIM17	CONT SYS 10US
//NVIC_SetPriority(EXTI15_10_IRQn, 2);		// ZCR INPUTS
...
SysTick->CTRL  = 0b111;				// Control Reg. CLK SRC | INT EN | CNT EN;
//////////////SysTick Settings///////////////////
// TIM5		MEAS PER
...
//LL_TIM_SetAutoReload(TIM17, 2749);

...
uint32_t exti_7R_fall_en_per  = 400;
uint32_t exti_rise_S_en_delay = 400;
uint32_t exti_fall_S_en_delay = 400;
uint32_t exti_rise_T_en_delay = 400;
uint32_t exti_fall_T_en_delay = 400;

...
float calculate_blm_op(void) {
    ...
    float mean_v = sum_v / buf_index;
    float mean_i = sum_i / buf_index;

    float var_v = sum_v2 - buf_index * mean_v * mean_v;
    float var_i = sum_i2 - buf_index * mean_i * mean_i;
    float cov_vi = sum_vi - buf_index * mean_v * mean_i;

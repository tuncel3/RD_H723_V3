...
void inline extern set_variables_from_EEP_fc(uint8_t scope) { // n012
    ...
    if (scope & SCOPE_DROPPER_LIMITS_FROM_EEP || scope == SCOPE_VAR_ALL_FROM_EEP) {
        ...
        set_dropper_l_hg_V = EpD[DEV_NOM_VOUT][0].V1 * (1 + (EpD[SET_DROPPER_L_HG][0].V1 / 100));
        set_dropper_l_lw_V  = EpD[DEV_NOM_VOUT][0].V1 * (1 - (EpD[SET_DROPPER_L_LW][0].V1 / 100));
    	set_dropper_l_hg_V=EpD[SET_DROPPER_L_HG][0].V1;
    	set_dropper_l_lw_V=EpD[SET_DROPPER_L_LW][0].V1;
    }

...
dropp_reg_high_lim=EpD[DEV_NOM_VOUT][0].V1*(1+dropp_reg_high_lim_add); // D.A. gerilim regülasyonu çıkış gerilimi
dropp_reg_low_lim=EpD[DEV_NOM_VOUT][0].V1*(1-dropp_reg_low_lim_sub); // D.A. gerilim regülasyonu çıkış gerilimi

	VLOAD_DC_HIGH_LIM=V_targ_con_sy*(1+(EpD[dropp_reg_high_lim_add][0].V1/100));
	VLOAD_DC_HIGH_LIM_ret=V_targ_con_sy*(1+(EpD[dropp_reg_high_lim_add][0].V1/100)-0.01);
	VLOAD_DC_LOW_LIM=V_targ_con_sy/(1+(EpD[dropp_reg_low_lim_add][0].V1/100));
	VLOAD_DC_LOW_LIM_ret=V_targ_con_sy/(1+(EpD[dropp_reg_low_lim_add][0].V1/100)-0.01);

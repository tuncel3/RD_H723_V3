...
State_Info state_list[] = {
	    // LED 16 BIT0 enum 0
    {  0, GENERAL_FAULT_FC,           0b000010, "Genel Arıza",     },
    {  1, BATTERY_FAULT_FC,           0b000000, "Akü Arızası",     },
    {  2, OVERTEMP_ALARM_FC,          0b010010, "Aşrı Sıckl Uyar", },
    {  3, OVERTEMP_OPEN_FC,           0b010111, "Aşrı Sıckl Açık", },
    {  4, BATTERY_CURRENT_LIMIT_FC,   0b000000, "Akü Akım Sınırı", },
    {  5, RECTIFIER_CURRENT_LIMIT_FC, 0b000000, "Doğrltc Akm Sınr",},
    {  6, DC_LEAK_NEG_FC,             0b010010, "DC Kaçak Negtf",  },
    ...
    { 15, VAC_ON_FC,                  0b000000, "VAC ON",          },
		...
		// LED 7 BIT0 enum 16
    { 16, ST_LOAD_MCCB_OFF,           0b010010, "Çıkş Sigrt Atık", },
    { 17, ST_DROPPER_K1,              0b000000, "Dropper 2 Bypass",},
    { 18, ST_DROPPER_K2,              0b000000, "Dropper 1 Bypass",},
    { 19, ST_BATT_MCCB_OFF,           0b010010, "Akü Sigrta Atık", },
    { 20, BOOST_CHARGE_FC,            0b010000, "Hızl Şarj",       },
    { 21, ST_FLOAT_CHARGE,            0b010000, "Norm Şarj",       },
    { 22, ST_LINE_MCCB_OFF,           0b010110, "Girş Sigrt Atık", },
    	// LED 7 BIT6 enum 22
    { 23, RECT_SHORT_FC,              0b000110, "DC Kısa Devre",   },
    { 24, BATT_SHORT_FC,              0b000110, "Akü Kısa Devre",  },
    { 25, BATT_REVERSE_FC,            0b010010, "Akü Ters",        },
    { 26, ST_BATT_LINE_BROKEN,        0b010011, "Akü Hattı Kopuk", },
    { 27, BAT_TEMP_ZERO_FC,           0b010011, "Akü Sıcklk Sıfr", },
    { 28, BAT_TEMP_50_FC,             0b010111, "Akü Sıcklk 50 C", },
    ...
    { 37, LOAD_DC_HG_FC,              0b010111, "Yük VDC Yüksk",   },
    { 38, LOAD_DC_LW_FC,              0b010011, "Yük VDC Düşük",   },
    ...
    { 44, FAN_FAULT_FC,               0b000000, "Fan Arz",         },

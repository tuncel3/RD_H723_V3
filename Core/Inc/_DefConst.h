...
State_Info state_list[] = {
	...
	{ DC_LEAK_NEGATIVE_FC,        0b10010,	"DC Kaçak Negtf",      DC_LEAK_NEGATIVE_FC_REL, 6, 0},
	{ DC_LEAK_POSITIVE_FC,        0b10010,	"DC Kaçak Poztf",      DC_LEAK_POSITIVE_FC_REL, 5, 0},
	...
	{ LOAD_DC_HG_FC,              0b10111,	"Yük VDC Yüksk",       LOAD_DC_HG_FC_REL, 3},
	{ LOAD_DC_LW_FC,              0b10011,	"Yük VDC Düşük",       LOAD_DC_LW_FC_REL, 4},
	...
	{ FAN_FAULT_FC,               0b00000,	"Fan Arz",             FAN_FAULT_FC_REL, 11},
...
rel_dat_stru REL_DAT_TB[] = {
	...
	{ DC_LEAK_POSITIVE_FC_REL,   0, "DC Kaçak Poztf", 	DC_LEAK_POSITIVE_FC },
	{ DC_LEAK_NEGATIVE_FC_REL,   0, "DC Kaçak Negtf", 	DC_LEAK_NEGATIVE_FC },
	{ LINE_FUSE_OFF_FC_REL,      0, "Giriş Sigr Off", 	ST_LINE_MCCB_OFF },
	{ BATT_FUSE_OFF_FC_REL,      0, "Akü Sigrta Off", 	ST_BATT_MCCB_OFF },
	{ LOAD_FUSE_OFF_FC_REL,      0, "Yük Sigrt Atık", 	ST_LOAD_MCCB_OFF },

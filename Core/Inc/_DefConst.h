...
RollingAverage IAC_R_rms_sc;
RollingAverage IAC_S_rms_sc;
RollingAverage IAC_T_rms_sc;
...
uint32_t charge_mode_timed_float=0;
uint32_t charge_mode_timed_boost=0;
...
EEPROM_Data_Type EpD[NUM_SET_ENUM][2] = {
    ...
    { {SET_BATT_DISC_CHK_EN, 1.0}, {SET_BATT_DISC_CHK_EN, 1.0} },
...
{"Akü Hat Kopuk", SET_BATT_DISC_CHK_EN, 2},
...
float Irect_set_limit_max=0.0f; // updated at startup and when DEV_NOM_VOUT changed
float Irect_set_limit_min=0.0f; // updated at startup and when DEV_NOM_VOUT changed
float Ibat_charge_set_limit_max=0; // updated at startup and when DEV_NOM_VOUT changed
float Ibat_charge_set_limit_min=0; // updated at startup and when DEV_NOM_VOUT changed
...
State_Info state_list[] = {
    // LED 16 BIT0 enum 0
    { GENERAL_FAULT_FC,           0b100010, "Genel Arıza",      GENERAL_FAULT_FC_REL,     15, 0 },
    { BATTERY_FAULT_FC,           0b100000, "Akü Arızası",      BATTERY_FAULT_FC_REL,     14, 0 },
    { OVERTEMP_ALARM_FC,          0b110010, "Aşrı Sıckl Uyar",  OVERTEMP_ALARM_FC_REL,    10, 0 },
    { OVERTEMP_OPEN_FC,           0b010111, "Aşrı Sıckl Açık",  OVERTEMP_OPEN_FC_REL,     99, 0 },
    { BATTERY_CURRENT_LIMIT_FC,   0b000000, "Akü Akım Sınırı",  NUM_REL_CODES,            99, 0 },
    { RECTIFIER_CURRENT_LIMIT_FC, 0b000000, "Doğrltc Akm Sınr", NUM_REL_CODES,            99, 0 },
    { DC_LEAK_NEG_FC,             0b110010, "DC Kaçak Negtf",   DC_LEAK_NEG_FC_REL,        6, 0 },
    { DC_LEAK_POS_FC,             0b110010, "DC Kaçak Poztf",   DC_LEAK_POS_FC_REL,        5, 0 },
    { RECT_DC_LW_FC,              0b010011, "Doğr VDC Düşük",   RECT_DC_LW_FC_REL,        99, 0 },
    { RECT_DC_HG_FC,              0b010111, "Doğr VDC Yüksk",   RECT_DC_HG_FC_REL,        99, 0 },
    { VAC_LO_FC,                  0b110110, "Şebeke Düşük",     VAC_LO_FC_REL,             2, 0 },
    { VAC_HG_FC,                  0b110110, "Şebeke Yüksek",    VAC_HG_FC_REL,             1, 0 },
    { STOP_FC,                    0b100010, "Stop",             START_STOP_REL,            0, 0 },
    { START_FC,                   0b100000, "Start",            START_STOP_REL,            0, 0 },
    { VAC_OFF_FC,                 0b010110, "VAC OFF",          VAC_OFF_FC_REL,           99, 0 },
    { VAC_ON_FC,                  0b000000, "VAC ON",           VAC_ON_FC_REL,            99, 0 },
    // LED 16 BIT15 enum 15
    // LED 7 BIT0 enum 16
    { ST_LOAD_MCCB_OFF,           0b110010, "Çıkş Sigrt Atık",  LOAD_MCCB_OFF_REL,         9, 0 },
    { ST_DROPPER_K1,              0b000000, "Dropper 2 Bypass", NUM_REL_CODES,            99, 0 },
    { ST_DROPPER_K2,              0b000000, "Dropper 1 Bypass", NUM_REL_CODES,            99, 0 },
    { ST_BATT_MCCB_OFF,           0b110010, "Akü Sigrta Atık",  BATT_MCCB_OFF_REL,         8, 0 },
    { BOOST_CHARGE_FC,            0b010000, "Hızl Şarj",        BOOST_CHARGE_REL,         99, 0 },
    { ST_FLOAT_CHARGE,            0b010000, "Norm Şarj",        FLOAT_CHARGE_REL,         99, 0 },
    { ST_LINE_MCCB_OFF,           0b110110, "Girş Sigrt Atık",  LINE_MCCB_OFF_REL,         7, 0 },
    // LED 7 BIT6 enum 22
    { RECT_SHORT_FC,              0b000110, "DC Kısa Devre",    NUM_REL_CODES,            99, 0 },
    { BATT_SHORT_FC,              0b000110, "Akü Kısa Devre",   NUM_REL_CODES,            99, 0 },
    { BATT_REVERSE_FC,            0b110010, "Akü Ters",         BATT_REVERSE_FC_REL,      13, 0 },
    { ST_BATT_LINE_BROKEN,        0b110011, "Akü Hattı Kopuk",  BATT_LINE_BROKEN_FC_REL,  12, 0 },
    { BAT_TEMP_ZERO_FC,           0b010011, "Akü Sıcklk Sıfr",  BAT_TEMP_ZERO_FC_REL,     99, 0 },
    { BAT_TEMP_50_FC,             0b010111, "Akü Sıcklk 50 C",  BAT_TEMP_50_FC_REL,       99, 0 },
    // REL MB 8 BIT0 enum 31
    { AUX_REL1_REL,               0b000000, "Aux Rel 1",        NUM_REL_CODES,            99, 0 },
    { THY_FAN1_REL,               0b000000, "Tristör Fan 1",    NUM_REL_CODES,            99, 0 },
    { TRF_FAN2_REL,               0b000000, "Trafo Fan 2",      NUM_REL_CODES,            99, 0 },
    { DROP_FAN3_REL,              0b000000, "Dropper Fan 3",    NUM_REL_CODES,            99, 0 },
    { AC_CON1_REL,                0b000000, "AC KONT1 RÖL",     NUM_REL_CODES,            99, 0 },
    { AC_CON2_REL,                0b000000, "AC KONT2 RÖL",     NUM_REL_CODES,            99, 0 },
    { DROP_CON1_REL,              0b000000, "Dropper 1 Bypass", NUM_REL_CODES,            99, 0 },
    { DROP_CON2_REL,              0b000000, "Dropper 2 Bypass", NUM_REL_CODES,            99, 0 },
    // REL MB 8 BIT7 enum 36
    { LOAD_DC_HG_FC,              0b110111, "Yük VDC Yüksk",    LOAD_DC_HG_FC_REL,         3, 0 },
    { LOAD_DC_LW_FC,              0b110011, "Yük VDC Düşük",    LOAD_DC_LW_FC_REL,         4, 0 },
    { MANUAL_CHARGE_FC,           0b000000, "(Man)",            NUM_REL_CODES,            99, 0 },
    { AUTO_CHARGE_ST,             0b000000, "(Oto)",            NUM_REL_CODES,            99, 0 },
    { TIMED_CHARGE_FC,            0b010000, "(Zmn)",            NUM_REL_CODES,            99, 0 },
    { SOFT_START_ST,              0b000000, "SFT S",            NUM_REL_CODES,            99, 0 },
    { EEPROM_FAULT_FC,            0b000000, "Kayit Sist Arz",   NUM_REL_CODES,            99, 0 },
    { FAN_FAULT_FC,               0b100000, "Fan Arz",          FAN_FAULT_FC_REL,         11, 0 },
    { RTC_FAULT_FC,               0b000000, "RTC Arz",          NUM_REL_CODES,            99, 0 },
    { VAC_R_RMS_HG_FAULT_FC,      0b000000, "VINR RMS Yüksek",  NUM_REL_CODES,            99, 0 },
    { VAC_S_RMS_HG_FAULT_FC,      0b000000, "VINS RMS Yüksek",  NUM_REL_CODES,            99, 0 },
    { VAC_T_RMS_HG_FAULT_FC,      0b000000, "VINT RMS Yüksek",  NUM_REL_CODES,            99, 0 },
    { VAC_R_RMS_LW_FAULT_FC,      0b000000, "VINR RMS Düşük",   NUM_REL_CODES,            99, 0 },
    { VAC_S_RMS_LW_FAULT_FC,      0b000000, "VINS RMS Düşük",   NUM_REL_CODES,            99, 0 },
    { VAC_T_RMS_LW_FAULT_FC,      0b000000, "VINT RMS Düşük",   NUM_REL_CODES,            99, 0 },
    { VAC_R_RMS_0_FAULT_FC,       0b000000, "VINR RMS Yok",     NUM_REL_CODES,            99, 0 },
    { VAC_S_RMS_0_FAULT_FC,       0b000000, "VINS RMS Yok",     NUM_REL_CODES,            99, 0 },
    { VAC_T_RMS_0_FAULT_FC,       0b000000, "VINT RMS Yok",     NUM_REL_CODES,            99, 0 },
};
...
//	{ VAC_HG_FC_REL,             0, "Şebeke Yüksek", 	VAC_HG_FC },
//	{ VAC_LO_FC_REL,             0, "Şebeke Düşük", 	VAC_LO_FC },
//	{ LOAD_DC_HG_FC_REL,         0, "Yük VDC Yüksk", 	LOAD_DC_HG_FC },
//	{ LOAD_DC_LW_FC_REL,         0, "Yük VDC Düşük", 	LOAD_DC_LW_FC },
//	{ DC_LEAK_POS_FC_REL,   	 0, "DC Kaçak Poztf", 	DC_LEAK_POS_FC },
//	{ DC_LEAK_NEG_FC_REL,   	 0, "DC Kaçak Negtf", 	DC_LEAK_NEG_FC },
//	{ LINE_MCCB_OFF_REL,      0, "Giriş Sigr Off", 	ST_LINE_MCCB_OFF },
//	{ BATT_MCCB_OFF_REL,      0, "Akü Sigrta Off", 	ST_BATT_MCCB_OFF },
//	{ LOAD_MCCB_OFF_REL,      0, "Yük Sigrt Atık", 	ST_LOAD_MCCB_OFF },
//	{ OVERTEMP_ALARM_FC_REL,     0, "Aşrı Sıck Uyar", 	OVERTEMP_ALARM_FC },
//	{ FAN_FAULT_FC_REL,          0, "Fan Arızası", 		FAN_FAULT_FC },
//	{ BATT_LINE_BROKEN_FC_REL,   0, "Akü Hattı Kopuk", 	ST_BATT_LINE_BROKEN },
...
//	{ BOOST_CHARGE_REL,       0, "Hızlı Şarj", 		BOOST_CHARGE_FC },
//	{ FLOAT_CHARGE_REL,       0, "Normal Şarj", 		ST_FLOAT_CHARGE },

...
State_Info state_list[] = {
	...
	{ OVERTEMP_ALARM_FC,          0b00010,	"Aşrı Sıckl Uyar",     OVERTEMP_ALARM_FC_REL },
	{ OVERTEMP_OPEN_FC,           0b00111,	"Aşrı Sıckl Açık",     OVERTEMP_OPEN_FC_REL },
	...
	{ DC_LEAK_NEGATIVE_FC,        0b00010,	"DC Kaçak Negatif",    DC_LEAK_NEGATIVE_FC_REL },
	{ DC_LEAK_POSITIVE_FC,        0b00010,	"DC Kaçak Pozitif",    DC_LEAK_POSITIVE_FC_REL },
	{ RECT_DC_LW_FC,              0b00011,	"Doğr VDC Düşük",      RECT_DC_LW_FC_REL },
	{ RECT_DC_HG_FC,              0b00111,	"Doğr VDC Yüksk",      RECT_DC_HG_FC_REL },
	{ VAC_LO_FC,                  0b00110,	"Şebeke Düşük",        VAC_LO_FC_REL },
	{ VAC_HG_FC,                  0b00110,	"Şebeke Yüksek",       VAC_HG_FC_REL },
	{ STOP_FC,                    0b00010,	"Manuel Durdur",       NUM_REL_CODES },
	{ START_FC,                   0b00000,	"Başlat",              NUM_REL_CODES },
	{ VAC_OFF_FC,                 0b00110,	"VAC OFF",             VAC_OFF_FC_REL },
	{ VAC_ON_FC,                  0b00000,	"VAC ON",              VAC_ON_FC_REL },
	// LED 16 BIT15	enum 15
	// LED 7 BIT0 enum 16
	{ LOAD_FUSE_OFF_FC,      	  0b00010,	"Çıkış Sigrt Atık",    LOAD_FUSE_OFF_FC_REL },
	{ DROPPER2_BYP_FC,      	  0b00000,	"Dropper 2 Bypass",    NUM_REL_CODES },
	{ DROPPER1_BYP_FC,      	  0b00000,	"Dropper 1 Bypass",    NUM_REL_CODES },
	{ BATT_FUSE_OFF_FC,           0b00010,	"Akü Sigorta Atık",    BATT_FUSE_OFF_FC_REL },
	{ BOOST_CHARGE_FC,      	  0b00000,	"Hızlı Şarj",          BOOST_CHARGE_FC_REL },
	{ FLOAT_CHARGE_FC,      	  0b00000,	"Normal Şarj",         FLOAT_CHARGE_FC_REL },
	{ LINE_FUSE_OFF_FC,      	  0b00110,	"Giriş Sigrt Atık",    LINE_FUSE_OFF_FC_REL },
	// LED 7 BIT6 enum 22
	{ RECT_SHORT_FC,              0b00110,	"DC Kısa Devre",       NUM_REL_CODES },
	{ BATT_SHORT_FC,              0b00110,	"Akü Kısa Devre",      NUM_REL_CODES },
	{ BATT_REVERSE_FC,            0b00010,	"Akü Ters",            BATT_REVERSE_FC_REL },
	{ BATT_LINE_BROKEN_FC,        0b00010,	"Akü Hattı Kopuk",     BATT_LINE_BROKEN_FC_REL },
	{ BAT_TEMP_ZERO_FC,           0b00011,	"Akü Sıcaklk Sıfr",    BAT_TEMP_ZERO_FC_REL },
	{ BAT_TEMP_50_FC,          	  0b00111,	"Akü Sıcaklk 50 C",    BAT_TEMP_50_FC_REL },
	...
	{ LOAD_DC_HG_FC,              0b00111,	"Yük VDC Yüksk",       LOAD_DC_HG_FC_REL },
	{ LOAD_DC_LW_FC,              0b00011,	"Yük VDC Düşük",       LOAD_DC_LW_FC_REL },

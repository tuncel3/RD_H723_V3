...
State_Info state_list[] = {
    ...
    {  3, OVERTEMP_OPEN_FC,           0b10111, "Aşrı Sıckl Açık", },
    {  4, BATTERY_CURRENT_LIMIT_FC,   0b00000, "Akü Akım Sınırı", },
    {  5, RECTIFIER_CURRENT_LIMIT_FC, 0b00000, "Doğrltc Akm Sınr",},
    {  6, DC_LEAK_NEG_FC,             0b10010, "DC Kaçak Negtf",  },
    {  7, DC_LEAK_POS_FC,             0b10010, "DC Kaçak Poztf",  },
    {  8, RECT_DC_LW_FC,              0b10011, "Doğr VDC Düşük",  },
    {  9, RECT_DC_HG_FC,              0b10111, "Doğr VDC Yüksk",  },
    { 10, VAC_LO_FC,                  0b10110, "Şebeke Düşük",    },
    { 11, VAC_HG_FC,                  0b10110, "Şebeke Yüksek",   },
    { 12, STOP_FC,                    0b00010, "Stop",            },
    ...
    { 19, ST_BATT_MCCB_OFF,           0b10010, "Akü Sigrta Atık", },
    ...
    { 32, DROP_FAN3_REL,              0b00000, "Dropper Fan 3",   },
    { 33, AC_CON1_REL,                0b00000, "AC KONT1 RÖL",    },
    ...
    { 40, AUTO_CHARGE_ST,             0b00000, "(Oto)",           },
    { 41, TIMED_CHARGE_FC,            0b10000, "(Zmn)",           },
    { 42, SOFT_START_ST,              0b00000, "SFT S",           },
    { 43, EEPROM_FAULT_FC,            0b00000, "Kayit Sist Arz",  },
    { 44, FAN_FAULT_FC,               0b00000, "Fan Arz",         },
    { 45, RTC_FAULT_FC,               0b00000, "RTC Arz",         },
    { 46, USER_STOP_FC,               0b00100, "Kullanıcı Durdur",         },
    { 47, VAC_R_RMS_HG_FAULT_FC,      0b00000, "VINR RMS Yüksek", },
    { 48, VAC_S_RMS_HG_FAULT_FC,      0b00000, "VINS RMS Yüksek", },
    { 49, VAC_T_RMS_HG_FAULT_FC,      0b00000, "VINT RMS Yüksek", },
    { 50, VAC_R_RMS_LW_FAULT_FC,      0b00000, "VINR RMS Düşük",  },
    { 51, VAC_S_RMS_LW_FAULT_FC,      0b00000, "VINS RMS Düşük",  },
    { 52, VAC_T_RMS_LW_FAULT_FC,      0b00000, "VINT RMS Düşük",  },
    { 53, VAC_R_RMS_0_FAULT_FC,       0b00000, "VINR RMS Yok",    },
    { 54, VAC_S_RMS_0_FAULT_FC,       0b00000, "VINS RMS Yok",    },
    { 55, VAC_T_RMS_0_FAULT_FC,       0b00000, "VINT RMS Yok",    },
};

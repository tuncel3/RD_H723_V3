...
//uint8_t user_wants_allows_thy_drv = 0;
...
EEPROM_Data_Type EpD[NUM_SET_ENUM][2] = {
    ...
    { {SET_DROPP_L_LW_PERC, 0.0}, {SET_DROPP_L_LW_PERC, 0.0} },
...
State_Info state_list[] = {
	    // LED 16 BIT0 enum 0
    {  0, GENERAL_FAULT_FC,           0b100010, "Genel Arıza",     },
    {  1, BATTERY_FAULT_FC,           0b100000, "Akü Arızası",     },
    {  2, OVERTEMP_ALARM_FC,          0b110010, "Aşrı Sıckl Uyar", },
    {  3, OVERTEMP_OPEN_FC,           0b110111, "Aşrı Sıckl Açık", },
    {  4, BATTERY_CURRENT_LIMIT_FC,   0b000000, "Akü Akım Sınırı", },
    {  5, RECTIFIER_CURRENT_LIMIT_FC, 0b000000, "Doğrltc Akm Sınr",},
    {  6, DC_LEAK_NEG_FC,             0b110010, "DC Kaçak Negtf",  },
    {  7, DC_LEAK_POS_FC,             0b110010, "DC Kaçak Poztf",  },
    {  8, RECT_DC_LW_FC,              0b110011, "Doğr VDC Düşük",  },
    {  9, RECT_DC_HG_FC,              0b110111, "Doğr VDC Yüksk",  },
    { 10, VAC_LO_FC,                  0b110110, "Şebeke Düşük",    },
    { 11, VAC_HG_FC,                  0b110110, "Şebeke Yüksek",   },
    { 12, STOP_FC,                    0b000010, "Stop",            },
    { 13, START_FC,                   0b100000, "Start",           },
    { 14, VAC_OFF_FC,                 0b110110, "VAC OFF",         },
    { 15, VAC_ON_FC,                  0b100000, "VAC ON",          },
		// LED 16 BIT15 enum 15
		// LED 7 BIT0 enum 16
    { 16, ST_LOAD_MCCB_OFF,           0b110010, "Çıkş Sigrt Atık", },
    { 17, ST_DROPPER_K1,              0b000000, "Dropper 2 Bypass",},
    ...
    { 24, BATT_SHORT_FC,              0b000110, "Akü Kısa Devre",  },
    { 25, BATT_REVERSE_FC,            0b110010, "Akü Ters",        },
    { 26, ST_BATT_LINE_BROKEN,        0b110011, "Akü Hattı Kopuk", },
    { 27, BAT_TEMP_ZERO_FC,           0b110011, "Akü Sıcklk Sıfr", },
    { 28, BAT_TEMP_50_FC,             0b110111, "Akü Sıcklk 50 C", },
    	// REL MB 8 BIT0 enum 31
    { 29, AUX_REL1_REL,               0b000000, "Aux Rel 1",       },
    { 30, THY_FAN1_REL,               0b000000, "Tristör Fan 1",   },
    { 31, TRF_FAN2_REL,               0b000000, "Trafo Fan 2",     },
    { 32, DROP_FAN3_REL,              0b000000, "Dropper Fan 3",   },
    { 33, AC_CON1_REL,                0b000000, "AC KONT1 RÖL",    },
    { 34, AC_CON2_REL,                0b000000, "AC KONT2 RÖL",    },
    { 35, DROP_CON1_REL,              0b000000, "Dropper 1 Bypass",},
    { 36, DROP_CON2_REL,              0b000000, "Dropper 2 Bypass",},
    	// REL MB 8 BIT7 enum 36
    { 37, LOAD_DC_HG_FC,              0b110111, "Yük VDC Yüksk",   },
    { 38, LOAD_DC_LW_FC,              0b110011, "Yük VDC Düşük",   },
    { 39, MANUAL_CHARGE_FC,           0b000000, "(Man)",           },
    { 40, AUTO_CHARGE_ST,             0b000000, "(Oto)",           },
    { 41, TIMED_CHARGE_FC,            0b010000, "(Zmn)",           },
    { 42, SOFT_START_ST,              0b000000, "SFT S",           },
    { 43, EEPROM_FAULT_FC,            0b000000, "Kayit Sist Arz",  },
    { 44, FAN_FAULT_FC,               0b100000, "Fan Arz",         },
    { 45, RTC_FAULT_FC,               0b000000, "RTC Arz",         },
    { 46, USER_STOP_FC,               0b000100, "Kullanıcı Durdur",         },
    { 47, VAC_R_RMS_HG_FAULT_FC,      0b000000, "VINR RMS Yüksek", },
    { 48, VAC_S_RMS_HG_FAULT_FC,      0b000000, "VINS RMS Yüksek", },
    { 49, VAC_T_RMS_HG_FAULT_FC,      0b000000, "VINT RMS Yüksek", },
    { 50, VAC_R_RMS_LW_FAULT_FC,      0b000000, "VINR RMS Düşük",  },
    { 51, VAC_S_RMS_LW_FAULT_FC,      0b000000, "VINS RMS Düşük",  },
    { 52, VAC_T_RMS_LW_FAULT_FC,      0b000000, "VINT RMS Düşük",  },
    { 53, VAC_R_RMS_0_FAULT_FC,       0b000000, "VINR RMS Yok",    },
    { 54, VAC_S_RMS_0_FAULT_FC,       0b000000, "VINS RMS Yok",    },
    { 55, VAC_T_RMS_0_FAULT_FC,       0b000000, "VINT RMS Yok",    },
};

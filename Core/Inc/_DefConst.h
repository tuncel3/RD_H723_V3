...
State_Info state_list[] = {
    {  0, GENERAL_FAULT_FC,           0b00010, "Genel Arıza",       15},
    {  1, BATTERY_FAULT_FC,           0b00000, "Akü Arızası",       14},
    {  2, OVERTEMP_ALARM_FC,          0b10010, "Aşrı Sıckl Uyar",   10},
    {  3, OVERTEMP_OPEN_FC,           0b10111, "Aşrı Sıckl Açık",   99},
    {  4, BATTERY_CURRENT_LIMIT_FC,   0b00000, "Akü Akım Sınırı",   99},
    {  5, RECTIFIER_CURRENT_LIMIT_FC, 0b00000, "Doğrltc Akm Sınr",  99},
    {  6, DC_LEAK_NEG_FC,             0b10010, "DC Kaçak Negtf",     6},
    {  7, DC_LEAK_POS_FC,             0b10010, "DC Kaçak Poztf",     5},
    {  8, RECT_DC_LW_FC,              0b10011, "Doğr VDC Düşük",    99},
    {  9, RECT_DC_HG_FC,              0b10111, "Doğr VDC Yüksk",    99},
    { 10, VAC_LO_FC,                  0b10110, "Şebeke Düşük",       2},
    { 11, VAC_HG_FC,                  0b10110, "Şebeke Yüksek",      1},
    { 12, STOP_FC,                    0b00010, "Stop",              99},
    { 13, START_FC,                   0b00000, "Start",              0},
    { 14, VAC_OFF_FC,                 0b10110, "VAC OFF",           99},
    { 15, VAC_ON_FC,                  0b00000, "VAC ON",            99},
    { 16, ST_LOAD_MCCB_OFF,           0b10010, "Çıkş Sigrt Atık",    9},
    { 17, ST_DROPPER_K1,              0b00000, "Dropper 2 Bypass",  99},
    { 18, ST_DROPPER_K2,              0b00000, "Dropper 1 Bypass",  99},
    { 19, ST_BATT_MCCB_OFF,           0b10010, "Akü Sigrta Atık",    8},
    { 20, BOOST_CHARGE_FC,            0b10000, "Hızl Şarj",         99},
    { 21, ST_FLOAT_CHARGE,            0b10000, "Norm Şarj",         99},
    { 22, ST_LINE_MCCB_OFF,           0b10110, "Girş Sigrt Atık",    7},
    { 23, RECT_SHORT_FC,              0b00110, "DC Kısa Devre",     99},
    { 24, BATT_SHORT_FC,              0b00110, "Akü Kısa Devre",    99},
    { 25, BATT_REVERSE_FC,            0b10010, "Akü Ters",          13},
    { 26, ST_BATT_LINE_BROKEN,        0b10011, "Akü Hattı Kopuk",   12},
    { 27, BAT_TEMP_ZERO_FC,           0b10011, "Akü Sıcklk Sıfr",   99},
    { 28, BAT_TEMP_50_FC,             0b10111, "Akü Sıcklk 50 C",   99},
    { 29, AUX_REL1_REL,               0b00000, "Aux Rel 1",         99},
    { 30, THY_FAN1_REL,               0b00000, "Tristör Fan 1",     99},
    { 31, TRF_FAN2_REL,               0b00000, "Trafo Fan 2",       99},
    { 32, DROP_FAN3_REL,              0b00000, "Dropper Fan 3",     99},
    { 33, AC_CON1_REL,                0b00000, "AC KONT1 RÖL",      99},
    { 34, AC_CON2_REL,                0b00000, "AC KONT2 RÖL",      99},
    { 35, DROP_CON1_REL,              0b00000, "Dropper 1 Bypass",  99},
    { 36, DROP_CON2_REL,              0b00000, "Dropper 2 Bypass",  99},
    { 37, LOAD_DC_HG_FC,              0b10111, "Yük VDC Yüksk",      3},
    { 38, LOAD_DC_LW_FC,              0b10011, "Yük VDC Düşük",      4},
    { 39, MANUAL_CHARGE_FC,           0b00000, "(Man)",             99},
    { 40, AUTO_CHARGE_ST,             0b00000, "(Oto)",             99},
    { 41, TIMED_CHARGE_FC,            0b10000, "(Zmn)",             99},
    { 42, SOFT_START_ST,              0b00000, "SFT S",             99},
    { 43, EEPROM_FAULT_FC,            0b00000, "Kayit Sist Arz",    99},
    { 44, FAN_FAULT_FC,               0b00000, "Fan Arz",           11},
    { 45, RTC_FAULT_FC,               0b00000, "RTC Arz",           99},
    { 46, VAC_R_RMS_HG_FAULT_FC,      0b00000, "VINR RMS Yüksek",   99},
    { 47, VAC_S_RMS_HG_FAULT_FC,      0b00000, "VINS RMS Yüksek",   99},
    { 48, VAC_T_RMS_HG_FAULT_FC,      0b00000, "VINT RMS Yüksek",   99},
    { 49, VAC_R_RMS_LW_FAULT_FC,      0b00000, "VINR RMS Düşük",    99},
    { 50, VAC_S_RMS_LW_FAULT_FC,      0b00000, "VINS RMS Düşük",    99},
    { 51, VAC_T_RMS_LW_FAULT_FC,      0b00000, "VINT RMS Düşük",    99},
    { 52, VAC_R_RMS_0_FAULT_FC,       0b00000, "VINR RMS Yok",      99},
    { 53, VAC_S_RMS_0_FAULT_FC,       0b00000, "VINS RMS Yok",      99},
    { 54, VAC_T_RMS_0_FAULT_FC,       0b00000, "VINT RMS Yok",      99},
};
...
//    { DC_LEAK_POS_FC_REL,   6,  0, REL_NO, "DC Kaçak Poztf" },
//    { DC_LEAK_NEG_FC_REL,   7,  0, REL_NO, "DC Kaçak Negtf" },
//    { LINE_MCCB_OFF_REL,      8,  0, REL_NO, "Giriş Sigr Off" },
//    { BATT_MCCB_OFF_REL,      9,  0, REL_NO, "Akü Sigrta Off" },
//    { LOAD_MCCB_OFF_REL,      10, 0, REL_NO, "Yük Sigrt Atık" },

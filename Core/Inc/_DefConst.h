...
State_Info state_list[] = {
    // LED 16 BIT0 enum 0
    { GENERAL_FAULT_FC,           0b00010, "Genel Arıza",       15},
    { BATTERY_FAULT_FC,           0b00000, "Akü Arızası",       14},
    { OVERTEMP_ALARM_FC,          0b10010, "Aşrı Sıckl Uyar",   10},
    { OVERTEMP_OPEN_FC,           0b10111, "Aşrı Sıckl Açık",   99},
    { BATTERY_CURRENT_LIMIT_FC,   0b00000, "Akü Akım Sınırı",   99},
    { RECTIFIER_CURRENT_LIMIT_FC, 0b00000, "Doğrltc Akm Sınr",  99},
    { DC_LEAK_NEG_FC,             0b10010, "DC Kaçak Negtf",     6},
    { DC_LEAK_POS_FC,             0b10010, "DC Kaçak Poztf",     5},
    { RECT_DC_LW_FC,              0b10011, "Doğr VDC Düşük",    99},
    { RECT_DC_HG_FC,              0b10111, "Doğr VDC Yüksk",    99},
    { VAC_LO_FC,                  0b10110, "Şebeke Düşük",       2},
    { VAC_HG_FC,                  0b10110, "Şebeke Yüksek",      1},
    { STOP_FC,                    0b00010, "Stop",              99},
    { START_FC,                   0b00000, "Start",              0},
    { VAC_OFF_FC,                 0b10110, "VAC OFF",           99},
    { VAC_ON_FC,                  0b00000, "VAC ON",            99},
    // LED 16 BIT15 enum 15
    // LED 7 BIT0 enum 16
    { ST_LOAD_MCCB_OFF,           0b10010, "Çıkş Sigrt Atık",    9},
    { ST_DROPPER_K1,              0b00000, "Dropper 2 Bypass",  99},
    { ST_DROPPER_K2,              0b00000, "Dropper 1 Bypass",  99},
    { ST_BATT_MCCB_OFF,           0b10010, "Akü Sigrta Atık",    8},
    { BOOST_CHARGE_FC,            0b10000, "Hızl Şarj",         99},
    { ST_FLOAT_CHARGE,            0b10000, "Norm Şarj",         99},
    { ST_LINE_MCCB_OFF,           0b10110, "Girş Sigrt Atık",    7},
    // LED 7 BIT6 enum 22
    { RECT_SHORT_FC,              0b00110, "DC Kısa Devre",     99},
    { BATT_SHORT_FC,              0b00110, "Akü Kısa Devre",    99},
    { BATT_REVERSE_FC,            0b10010, "Akü Ters",          13},
    { ST_BATT_LINE_BROKEN,        0b10011, "Akü Hattı Kopuk",   12},
    { BAT_TEMP_ZERO_FC,           0b10011, "Akü Sıcklk Sıfr",   99},
    { BAT_TEMP_50_FC,             0b10111, "Akü Sıcklk 50 C",   99},
    // REL MB 8 BIT0 enum 31
    { AUX_REL1_REL,               0b00000, "Aux Rel 1",         99},
    { THY_FAN1_REL,               0b00000, "Tristör Fan 1",     99},
    { TRF_FAN2_REL,               0b00000, "Trafo Fan 2",       99},
    { DROP_FAN3_REL,              0b00000, "Dropper Fan 3",     99},
    { AC_CON1_REL,                0b00000, "AC KONT1 RÖL",      99},
    { AC_CON2_REL,                0b00000, "AC KONT2 RÖL",      99},
    { DROP_CON1_REL,              0b00000, "Dropper 1 Bypass",  99},
    { DROP_CON2_REL,              0b00000, "Dropper 2 Bypass",  99},
    // REL MB 8 BIT7 enum 36
    { LOAD_DC_HG_FC,              0b10111, "Yük VDC Yüksk",      3},
    { LOAD_DC_LW_FC,              0b10011, "Yük VDC Düşük",      4},
    { MANUAL_CHARGE_FC,           0b00000, "(Man)",             99},
    { AUTO_CHARGE_ST,             0b00000, "(Oto)",             99},
    { TIMED_CHARGE_FC,            0b10000, "(Zmn)",             99},
    { SOFT_START_ST,              0b00000, "SFT S",             99},
    { EEPROM_FAULT_FC,            0b00000, "Kayit Sist Arz",    99},
    { FAN_FAULT_FC,               0b00000, "Fan Arz",           11},
    { RTC_FAULT_FC,               0b00000, "RTC Arz",           99},
    { VAC_R_RMS_HG_FAULT_FC,      0b00000, "VINR RMS Yüksek",   99},
    { VAC_S_RMS_HG_FAULT_FC,      0b00000, "VINS RMS Yüksek",   99},
    { VAC_T_RMS_HG_FAULT_FC,      0b00000, "VINT RMS Yüksek",   99},
    { VAC_R_RMS_LW_FAULT_FC,      0b00000, "VINR RMS Düşük",    99},
    { VAC_S_RMS_LW_FAULT_FC,      0b00000, "VINS RMS Düşük",    99},
    { VAC_T_RMS_LW_FAULT_FC,      0b00000, "VINT RMS Düşük",    99},
    { VAC_R_RMS_0_FAULT_FC,       0b00000, "VINR RMS Yok",      99},
    { VAC_S_RMS_0_FAULT_FC,       0b00000, "VINS RMS Yok",      99},
    { VAC_T_RMS_0_FAULT_FC,       0b00000, "VINT RMS Yok",      99},
};

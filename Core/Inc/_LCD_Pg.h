...
inline extern void DROPPER_pg_disp(void) {
	...
	sprintf(L, " Kd 1 V %5.1f %%%5.1f", EpD[SET_DROPPER_K1_V][dropper_edit_mode].V1, set_dropper_k1_v_perc); 	GLCD_PrintString(0, 4*lnhg, L);
	sprintf(L, " Kd 2 V %5.1f %%%5.1f", EpD[SET_DROPPER_K2_V][dropper_edit_mode].V1, set_dropper_k2_v_perc); 	GLCD_PrintString(0, 5*lnhg, L);
    sprintf(L, ">");

...
if (DEVICE_SETT_Items[selected_DEVICE_SETT].V1==999) {
	...
	Rec_Dat_to_EEp_f(VRECT_DC_LOW_LIM_add);
        ...
        if (rel_disp_mode == 1) { // ekranda order değiştirildi. tabloda değiş
        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_code= REL_DAT_TB[rel_dat_tb_sel].rel_dat_nm;
        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_tb_desc= REL_DAT_TB[rel_dat_tb_sel].rel_dat_desc; // REL_DAT_TB den seçili olanı al ve SIRALI_TABLO_RELOUT ye kopyala
        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_tb_val= REL_DAT_TB[rel_dat_tb_sel].rel_dat_val;

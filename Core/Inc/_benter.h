...
//        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_code= TAM_TABLO_RELOUT[rel_dat_tb_sel].rel_dat_nm;
//        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_tb_desc= TAM_TABLO_RELOUT[rel_dat_tb_sel].rel_dat_desc; // REL_DAT_TB den seçili olanı al ve SIRALI_TABLO_RELOUT ye kopyala
//        	SIRALI_TABLO_RELOUT[rel_ord_tb_sel].rel_out_tb_val= TAM_TABLO_RELOUT[rel_dat_tb_sel].rel_dat_val;

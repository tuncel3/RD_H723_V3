...
// FREQUENCY (50ms loop)
	...
	exti_reen_delay_R_rise=round((((1/frq_cal_k)*per_r_dn_smp)/20e-6)*0.96);
	exti_reen_delay_R_fall=round((((1/frq_cal_k)*per_r_up_smp)/20e-6)*0.96); // üst cycle periyotta iken
	exti_reen_delay_S_rise=round((((1/frq_cal_k)*per_s_dn_smp)/20e-6)*0.96);
	exti_reen_delay_S_fall=round((((1/frq_cal_k)*per_s_up_smp)/20e-6)*0.96);
	exti_reen_delay_T_rise=round((((1/frq_cal_k)*per_t_dn_smp)/20e-6)*0.96);
	exti_reen_delay_T_fall=round((((1/frq_cal_k)*per_t_up_smp)/20e-6)*0.96);

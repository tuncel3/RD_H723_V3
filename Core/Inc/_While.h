...
// FREQUENCY (50ms loop)
	...
	zcrendely_R_U=round((((1/frq_cal_k)*per_r_up_smp)/20e-6)*0.96);
	zcrendely_R_D=round((((1/frq_cal_k)*per_r_dn_smp)/20e-6)*0.96);
	zcrendely_S_U=round((((1/frq_cal_k)*per_s_up_smp)/20e-6)*0.96);
	zcrendely_S_D=round((((1/frq_cal_k)*per_s_dn_smp)/20e-6)*0.96);
	zcrendely_T_U=round((((1/frq_cal_k)*per_t_up_smp)/20e-6)*0.96);
	zcrendely_T_D=round((((1/frq_cal_k)*per_t_dn_smp)/20e-6)*0.96);

...
// FREQUENCY (50ms loop)
	...
	exti_rise_R_reen_delay=round((((1/frq_cal_k)*per_r_dn_smp)/20e-6)*0.96);
	exti_fall_R_reen_delay=round((((1/frq_cal_k)*per_r_up_smp)/20e-6)*0.96); // üst cycle periyotta iken
	exti_rise_S_reen_delay=round((((1/frq_cal_k)*per_s_dn_smp)/20e-6)*0.96);
	exti_fall_S_reen_delay=round((((1/frq_cal_k)*per_s_up_smp)/20e-6)*0.96);
	exti_rise_T_reen_delay=round((((1/frq_cal_k)*per_t_dn_smp)/20e-6)*0.96);
	exti_fall_T_reen_delay=round((((1/frq_cal_k)*per_t_up_smp)/20e-6)*0.96);

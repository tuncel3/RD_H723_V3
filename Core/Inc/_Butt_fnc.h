...
//				temp_test_thy_1 += test_step_values[test_dig];
        ...
        if (rel_disp_mode == 1) {
			if (rel_ord_arrow_loc > 1) {
				...
				sirali_tablo_sel_index = (sirali_tablo_sel_index - 1 + rel_ord_tb_size) % rel_ord_tb_size;
			}
			rel_ord_tb_sel = (rel_ord_arrow_loc + sirali_tablo_sel_index) % rel_ord_tb_size;				// UP
	...
	if (CHARGE_SETT_Items[selected_CHARGE_SETT].V1==SET_CHARGE_MODE) {
        ...
        if (rel_disp_mode == 1) {
			if (rel_ord_arrow_loc < 4) {
				...
				sirali_tablo_sel_index = (sirali_tablo_sel_index + 1 + rel_ord_tb_size) % rel_ord_tb_size;	// DOWN
			}
			rel_ord_tb_sel = (rel_ord_arrow_loc + sirali_tablo_sel_index) % rel_ord_tb_size;

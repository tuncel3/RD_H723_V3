...
int main(void)
{
  ...
  NVIC_SetPriority(DebugMonitor_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),15, 0));
...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_ADC_REG_SetDataTransferMode(ADC1, LL_ADC_REG_DMA_TRANSFER_LIMITED);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_18, LL_ADC_SAMPLINGTIME_1CYCLE_5);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_19, LL_ADC_SAMPLINGTIME_1CYCLE_5);
  ...
  */
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC1, LL_ADC_REG_RANK_10, LL_ADC_CHANNEL_4);
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC1, LL_ADC_REG_RANK_11, LL_ADC_CHANNEL_9);
...
static void MX_I2C2_Init(void)
{
  ...
  */
  ...
  I2C_InitStruct.Timing = 0x00D056FC;
  I2C_InitStruct.AnalogFilter = LL_I2C_ANALOGFILTER_DISABLE;
  I2C_InitStruct.DigitalFilter = 0;
  I2C_InitStruct.OwnAddress1 = 222;
...
static void MX_TIM6_Init(void)
{
  ...
  TIM_InitStruct.CounterMode = LL_TIM_COUNTERMODE_UP;
  TIM_InitStruct.Autoreload = 54999;
...
static void MX_TIM15_Init(void)
{
  ...
  PE5   ------> TIM15_CH1
  */
  GPIO_InitStruct.Pin = TIM15_CH1_MOS_GT_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_4;
  LL_GPIO_Init(TIM15_CH1_MOS_GT_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM16_Init(void)
{
  ...
  NVIC_SetPriority(TIM16_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),15, 0));
...
static void MX_TIM23_Init(void)
{
  ...
  NVIC_SetPriority(TIM23_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),15, 0));
...
static void MX_TIM24_Init(void)
{
  ...
  NVIC_SetPriority(TIM24_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),15, 0));
...
static void MX_UART5_Init(void)
{
  ...
  */
  ...
  /* UART5_TX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_0, LL_DMAMUX1_REQ_UART5_TX);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOE, LL_GPIO_PIN_12|LL_GPIO_PIN_14|LL_GPIO_PIN_0|Buzzer_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_14|LL_GPIO_PIN_5|LL_GPIO_PIN_6|LL_GPIO_PIN_7
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOA, LL_GPIO_PIN_8|LL_GPIO_PIN_9|LL_GPIO_PIN_10|LL_GPIO_PIN_11
  ...
  GPIO_InitStruct.Pin = LL_GPIO_PIN_13|LL_GPIO_PIN_14|LL_GPIO_PIN_15|LL_GPIO_PIN_0
                          |LL_GPIO_PIN_1|LL_GPIO_PIN_2|LL_GPIO_PIN_3;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_12|LL_GPIO_PIN_14|LL_GPIO_PIN_0|Buzzer_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_14|LL_GPIO_PIN_5|LL_GPIO_PIN_6|LL_GPIO_PIN_7
                          |LL_GPIO_PIN_8|LL_GPIO_PIN_9;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
